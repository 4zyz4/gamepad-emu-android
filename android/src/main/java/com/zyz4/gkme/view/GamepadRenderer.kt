    ...
    fun render(
        ...
        for (pos in buttons) {
            ...
            when (pos.slideDirection) {
                com.zyz4.gkme.model.SlideDirection.DOWN -> {
                    val travelH = pos.travelDistance * cellW
                    height = height + travelH
                }
                com.zyz4.gkme.model.SlideDirection.UP -> {
                    val travelH = pos.travelDistance * cellW
                    top = top - travelH
                    height = height + travelH
                }
                com.zyz4.gkme.model.SlideDirection.RIGHT -> {
                    val travelW = pos.travelDistance * cellW
                    width = width + travelW
                }
                com.zyz4.gkme.model.SlideDirection.LEFT -> {
                    val travelW = pos.travelDistance * cellW
                    left = left - travelW
                    width = width + travelW
                }
