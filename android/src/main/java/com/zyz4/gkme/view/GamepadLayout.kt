...
import com.zyz4.gkme.view.inputdispatcher.SlotMatcher
import com.zyz4.gkme.view.inputdispatcher.EditCommand
import com.zyz4.gkme.view.inputdispatcher.toRawEvent
...
import com.zyz4.gkme.view.inputdispatcher.MouseInputDispatcher
...
class GamepadLayout @JvmOverloads constructor(
    ...
    private val dispatcher = GamepadInputDispatcher(
        ...
        hitResolver = com.zyz4.gkme.view.inputdispatcher.HitResolver,
        followAreaStrategy = com.zyz4.gkme.view.inputdispatcher.FollowAreaStrategy,
        swipeTriggerStrategy = com.zyz4.gkme.view.inputdispatcher.SwipeTriggerStrategy,
        slotMatcher = com.zyz4.gkme.view.inputdispatcher.SlotMatcher,
        clickDetector = com.zyz4.gkme.view.inputdispatcher.TouchpadClickDetector,
    )
    ...
    var currentGyroOrientation: GyroOrientation? = null
        private set
    var currentGyroActivateMode: com.zyz4.gkme.model.GyroActivateMode? = null
        private set
    var currentGyroMode: com.zyz4.gkme.model.GyroMode? = null
        private set
    ...
    fun loadPreset(preset: LayoutPreset) {
        currentButtons = preset.buttons.map {
            if (it.id == "centerArea") it.copy(id = "touchpad", linearTriggerEnabled = false, slideDirection = com.zyz4.gkme.model.SlideDirection.DOWN) else it
        }.let { list ->
...
/** Activate follow-area trigger for a joystick or dpadPad.
    ...
    private fun isTouchpadId(id: String): Boolean = com.zyz4.gkme.view.inputdispatcher.isTouchpadId(id)
